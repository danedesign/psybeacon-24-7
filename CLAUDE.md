...
This repo is very early-stage: module 1 (network discovery), most of module 2 (host launcher + VDD control), and module 3 (capture + NVENC encode + network send, verified end-to-end as of 2026-09-25) exist. Module 4 is architecture, not code.
